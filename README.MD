...
The `10604` build is a modded version of the `10603` metro music player that has total black splash screen, now playing auto scroll enabled on music reprodution and drive modeenabled by default.
