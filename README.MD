...
I've modded the [Metro App](https://github.com/MuntashirAkon/Metro) `10603`, to make it more adequate for driving.

    - 10603 has a full black splash screen.
    - 10604 open the now playing automatically on play and has the splash black.
    - 10605 open the drivemode on play and has the splash black.
    - 10606 open the drivemode on play, don't have bottom bar and has the splash black.

### Music organizer script

To help the indexation use this script

    chmod +x organize_car_music.sh
    ./organize_car_music.sh INPUT OUTPUT
